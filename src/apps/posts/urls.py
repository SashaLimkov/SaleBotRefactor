...
from .views import CompilationListView, CompilationTableView, CompilationDetailView, FinalCompilationSaveView,\
                    ...
                    CompilationDeleteView, PostDeleteView, ProductDeleteView
...
urlpatterns = [
    ...
    path('delete_compilatiom/<int:pk>', CompilationDeleteView.as_view(), name='delete_compilation'),
    path('delete_post/', PostDeleteView.as_view(), name='delete_post'),
    path('delete_product/', ProductDeleteView.as_view(), name='delete_item')
]
