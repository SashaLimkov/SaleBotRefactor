...
class UserPost(TimeBasedModel):
    ...
    post = models.ForeignKey(to=Post, on_delete=models.CASCADE, related_name='user_post', verbose_name='Пост')
    profile = models.ForeignKey(to='profiles.Profile', to_field='telegram_id', on_delete=models.CASCADE, verbose_name='Пользователь')
