...
class ChanelTelegram(TimeBasedModel):
    ...
    profile = models.ForeignKey(to='profiles.Profile', on_delete=models.CASCADE, verbose_name='Пользователь')
    chat_id = models.BigIntegerField('ID Канала')
    name_channel = models.CharField('Название канала', max_length=255)
