...
class CourseUser(TimeBasedModel):
    ...
    currency = models.ForeignKey(to='Currency', to_field='currency', on_delete=models.CASCADE,
                                 verbose_name='Валюта')
    profile = models.ForeignKey(to='profiles.Profile', to_field='telegram_id', on_delete=models.CASCADE,
