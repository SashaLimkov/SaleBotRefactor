...
async def user_signature_menu(call: types.CallbackQuery, callback_data: dict, state: FSMContext):
    ...
    if user_action == 0:
        ...
        text = get_message_by_name_for_user(name="enter_signature", telegram_id=user_id).text
        ...
        text_db = get_message_by_name_for_user(name="user_signature", telegram_id=user_id).text
